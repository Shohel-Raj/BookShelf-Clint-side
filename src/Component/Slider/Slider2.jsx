                    ...
                    <div className="hero-content text-neutral-content text-center relative ">
                        <div >
                             ...
                             <motion.h1
                                ...
                                className="mb-5 text-2xl font-semibold md:text-4xl md:font-bold pt-1.5 md:pt-4">Find Your Next Favorite Read</motion.h1>
                            <motion.p
                                ...
                                Explore curated collections, trending titles, and personalized recommendations—all at your fingertips in one dynamic bookshelf.
                            </motion.p>
